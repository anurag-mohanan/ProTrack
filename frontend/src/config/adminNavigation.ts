...
export const ADMIN_CREATE_ACTIONS: AdminCreateAction[] = [
  ...
  { id: 'stream', title: 'Stream', description: 'Add a business-line design stream.', icon: AccountTreeIcon, path: '/admin/streams?create=1' },
  { id: 'workstream', title: 'Workstream', description: 'Add a delivery workstream for the Command Center.', icon: AccountTreeIcon, path: '/admin/workstreams?create=1' },
...
export const ADMIN_MANAGE_ITEMS: AdminHubItem[] = [
  ...
  { id: 'streams', title: 'Streams', description: 'Business-line design streams and disciplines.', icon: AccountTreeIcon, path: '/admin/streams' },
  { id: 'workstreams', title: 'Workstreams', description: 'Delivery workstreams for the Projects Command Center.', icon: AccountTreeIcon, path: '/admin/workstreams' },
...
const ALL_AUDIT_ITEMS: AdminHubItem[] = [
  ...
  { id: 'security-center', title: 'Security Center', description: 'Security posture, sessions, lockouts, and governance policy.', icon: SecurityIcon, path: '/admin/security' },
